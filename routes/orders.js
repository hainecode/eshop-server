...
router.put('/:id', async (req, res) => {
    ...
    if(!order)
    return res.status(500).send('O pedido não pode ser atualizado.')
...
router.get('/get/totalsales', async (req, res) => {
    ...
    if(!totalSales) {
        return res.status(400).send('A venda dos pedidos não pode ser gerada.')
    }
